...
const HeroSlide = ({ slide, isActive }: HeroSlideProps) => {
  return (
    ...
    >
      <div className="grid min-h-[85vh] grid-rows-[auto_auto_auto] items-start gap-8 lg:min-h-[95vh] lg:grid-cols-[1.05fr_0.95fr] lg:grid-rows-1 lg:items-center lg:gap-14">
