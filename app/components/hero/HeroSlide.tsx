...
const HeroSlide = ({ slide, isActive }: HeroSlideProps) => {
  return (
    <div
      className={`absolute inset-0 px-6 py-10 sm:px-10 lg:px-16 transition-all duration-700 ${isActive ? "opacity-100 translate-x-0" : "pointer-events-none translate-x-6 opacity-0"}`}
    >
      <div className="grid min-h-[85vh] grid-rows-[auto_auto_auto] items-start gap-8 lg:min-h-[95vh] lg:grid-cols-[1.05fr_0.95fr] lg:grid-rows-[auto_auto] lg:items-center lg:gap-14">
        <div className="relative z-10 flex max-w-2xl flex-col gap-6 text-center lg:col-start-1 lg:row-start-1 lg:pl-6 lg:text-left xl:pl-10">
